document.addEventListener('DOMContentLoaded', function () {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        ...
        if (value.length < minLength) {
          errorMessage = getFieldLabel(form, field) + ' must be at least ' + minLength + ' characters.';
        }
      } else if (field.hasAttribute('maxlength') && value !== '') {
        const maxLength = parseInt(field.getAttribute('maxlength'), 10);
        if (value.length > maxLength) {
          errorMessage = getFieldLabel(form, field) + ' must not exceed ' + maxLength + ' characters.';
        }
  ...
  function clearFormErrors(form) {
    ...
    validFields.forEach(function (el) { el.classList.remove('field-valid'); });
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '5c08ecc8-3608-48c8-a14f-b6fd048b0b84',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '5c08ecc8-3608-48c8-a14f-b6fd048b0b84';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5c08ecc8-3608-48c8-a14f-b6fd048b0b84';
